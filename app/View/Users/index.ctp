<div class="jumbotron subhead" style="padding-top: 80px">
    <ul class="nav nav-list" >
        ...
        <li class="active"><?php echo $this->Html->link("List User",array('controller'=>'users','action'=>'index'));?></li>
...
<div class="users index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('verify_token'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($user['User']['verify_token']); ?>&nbsp;</td>
